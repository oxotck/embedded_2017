...
{ 
  ...
  FSMC_NORSRAMCmd(FSMC_NORSRAM_BANK4, ENABLE);
  
  /*!< LCD_SPI DeInit */
  FSMC_NORSRAMDeInit(FSMC_NORSRAM_BANK4);
...
//  FSMC_NORSRAMInitStructure.ReadWriteTimingStruct = &p;
//  FSMC_NORSRAMInitStructure.WriteTimingStruct = &p;
