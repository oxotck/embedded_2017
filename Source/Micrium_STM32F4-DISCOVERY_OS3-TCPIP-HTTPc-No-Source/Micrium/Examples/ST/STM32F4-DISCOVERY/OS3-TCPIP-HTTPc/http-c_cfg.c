...
*                     https://doc.micrium.comm/HTTPc.
*********************************************************************************************************
*/

#define    MICRIUM_SOURCE
#define    HTTPc_CFG_MODULE
...
*/
         ...
         10u,                                                   /* .TaskDly_ms (HTTPc Task delay in milliseconds)       */
...
*/
         ...
         5u,                                                    /* .ConnQ_Size              (Connection Queue size)     */
         5000u,                                                 /* .ConnConnectTimeout_ms   (Connect timeout in ms)     */
...
*/
         ...
         5u,                                                    /* .ReqQ_Size (Request Queue size)                      */
...
#define  HTTPc_OS_CFG_TASK_PRIO                  10
#endif

#ifndef  HTTPc_OS_CFG_TASK_STK_SIZE
#define  HTTPc_OS_CFG_TASK_STK_SIZE            8192
#endif

const  HTTPc_TASK_CFG  HTTPc_TaskCfg = {
