...
#ifdef TRACE_CFG_MAX_EVENTS
#define EVENT_BUFFER_SIZE    TRACE_CFG_MAX_EVENTS
#else
 ...
 *
 ******************************************************************************/
#ifdef TRACE_CFG_MAX_TASK
#define NTask             TRACE_CFG_MAX_TASK
#else
#define NTask             16
#endif

#ifdef TRACE_CFG_MAX_ISR
#define NISR              TRACE_CFG_MAX_ISR
#else
#define NISR              8
#endif

#ifdef TRACE_CFG_MAX_Q
#define NQueue            TRACE_CFG_MAX_Q
#else
#define NQueue            16
#endif

#ifdef TRACE_CFG_MAX_SEM
#define NSemaphore        TRACE_CFG_MAX_SEM
#else
#define NSemaphore        32
#endif

#ifdef TRACE_CFG_MAX_MUTEX
#define NMutex            TRACE_CFG_MAX_MUTEX
#else
#define NMutex            8
#endif

#ifdef TRACE_CFG_MAX_FLAG
#define NFlag             TRACE_CFG_MAX_FLAG
#else
#define NFlag             2
#endif

#ifdef TRACE_CFG_MAX_MEM
#define NMem              TRACE_CFG_MAX_MEM
#else
#define NMem              2
#endif
...
#define TRACE_RECORDER_STORE_MODE   TRACE_STORE_MODE_STOP_WHEN_FULL   // TRACE_STORE_MODE_RING_BUFFER  or  TRACE_STORE_MODE_STOP_WHEN_FULL
