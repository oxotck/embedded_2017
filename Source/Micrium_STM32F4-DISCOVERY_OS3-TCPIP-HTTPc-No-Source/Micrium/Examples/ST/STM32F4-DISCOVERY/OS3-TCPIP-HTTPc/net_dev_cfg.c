...
const  NET_DEV_CFG_ETHER  NetDev_Cfg_STM32F407_0 = {
    ...
    1520u,                          /* Desired size      of device's large receive  buffers (in octets) [see Note #2].  */
       6u,                          /* Desired number    of device's large receive  buffers             [see Note #3a]. */
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
             ...
             3u,                    /* Desired number of device's receive  descriptors (see Note #7).                   */
   ...
   "00:00:00:00:00:01",             /* Desired device hardware address; may be NULL address or string ...               */
                                    /* ... if  device hardware address configured or set at run-time.                   */
};


const  NET_PHY_CFG_ETHER  NetPhy_Cfg_STM32F407_0 = {
...
const  NET_IF_CFG_LOOPBACK  NetIF_Cfg_Loopback = {
    ...
    1594u,                      /* Desired size      of interface's large transmit buffers (in octets) [see Note #2].   */
      ...
      64u,                      /* Desired size      of interface's small transmit buffers (in octets) [see Note #2].   */
