...
#define  NET_SOCK_CFG_CONN_ACCEPT_Q_SIZE_MAX    2u              /* maximum size. (See Note # 1)                         */
                                                                ...
                                                                /* (see Note #2):                                       */
#define  NET_SOCK_CFG_RX_Q_SIZE_OCTET           4380u           /* Configure socket receive  queue buffer size.         */
#define  NET_SOCK_CFG_TX_Q_SIZE_OCTET           4380u           /* Configure socket transmit queue buffer size.         */
